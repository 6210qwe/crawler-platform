...
from app.api.api_v1.endpoints import auth, users, exercises, study_notes, challenges, exercises_new, knowledge_base
...
api_router.include_router(knowledge_base.router, prefix="/knowledge", tags=["基础知识"])
